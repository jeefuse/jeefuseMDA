...
public class InputRender implements Render {
	...
	public InputRender(String prefix, Class uml2Class, Property property, Property parent) {
		this.prefix = prefix;
		this.parent = parent;
	...
	protected void styleClass() {
		...
		if (PageHelper.isRequired(property)) {
			cls.add("required");
		}
