...
public class EntityResultMsgJsonWriterManageByProperty
{
  protected static String nl;
  public static synchronized EntityResultMsgJsonWriterManageByProperty create(String lineSeparator)
  {
    nl = lineSeparator;
    EntityResultMsgJsonWriterManageByProperty result = new EntityResultMsgJsonWriterManageByProperty();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_5 = " ResultMsg json格式数据." + NL + " * " + NL + " * @author ";
  protected final String TEXT_6 = NL + " * @generated" + NL + " */" + NL + "public class ";
  protected final String TEXT_7 = " extends ResultJsonWriter<";
  protected final String TEXT_8 = "> {" + NL + "" + NL + "\t/**" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_9 = "(ResultMsg<";
  protected final String TEXT_10 = "> msg) {" + NL + "\t\tsuper(msg);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_11 = "(boolean success, ";
  protected final String TEXT_12 = " model, String message) {" + NL + "\t\tsuper(success, model, message);" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * @generated" + NL + "\t */" + NL + "\t@Override" + NL + "\tprotected void writeJsonModel(JsonGenerator g, ";
