...
public class EntityFlexiGridJsonWriterManageByProperty
{
  protected static String nl;
  public static synchronized EntityFlexiGridJsonWriterManageByProperty create(String lineSeparator)
  {
    nl = lineSeparator;
    EntityFlexiGridJsonWriterManageByProperty result = new EntityFlexiGridJsonWriterManageByProperty();
    nl = null;
    return result;
  }
...
//String flexiGridJsonWriterByPropertylassQualifiedName=actionByProperty.getClassQualifiedName();
    ...
    stringBuffer.append(flexiGridJsonWriterByPropertyPackageName);
