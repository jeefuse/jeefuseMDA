...
public class EntityManagerJSManageByPropertyForTreeGrid
{
  protected static String nl;
  public static synchronized EntityManagerJSManageByPropertyForTreeGrid create(String lineSeparator)
  {
    nl = lineSeparator;
    EntityManagerJSManageByPropertyForTreeGrid result = new EntityManagerJSManageByPropertyForTreeGrid();
    nl = null;
    return result;
  }
