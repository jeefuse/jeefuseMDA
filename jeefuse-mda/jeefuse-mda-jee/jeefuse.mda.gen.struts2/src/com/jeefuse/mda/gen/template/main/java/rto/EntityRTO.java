package com.jeefuse.mda.gen.template.main.java.rto;
...
public class EntityRTO
{
  ...
  protected final String TEXT_204 = ";" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * 用实体对象填充数据." + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void setModel(";
  protected final String TEXT_205 = " model) {";
  protected final String TEXT_206 = NL + "\t\tthis.setId(model.";
  protected final String TEXT_207 = "());//id ";
  protected final String TEXT_208 = NL + "\t\tthis.set";
  protected final String TEXT_209 = "(model.";
  protected final String TEXT_210 = "());//";
  protected final String TEXT_211 = " ";
  protected final String TEXT_212 = NL + "\t}" + NL + "\t" + NL + "\t// ------------------------------------------------------------------------" + NL + "\t// Utils" + NL + "\t// ------------------------------------------------------------------------";
  protected final String TEXT_213 = NL;
  protected final String TEXT_214 = NL + "\t/** @generated */" + NL + "\t@Override" + NL + "\tpublic String toString() {" + NL + "\t\treturn ";
  protected final String TEXT_215 = ";" + NL + "\t}" + NL + "" + NL + "" + NL + "}";
