...
public class EntityManagerJSManageByPropertyForTree
{
  protected static String nl;
  public static synchronized EntityManagerJSManageByPropertyForTree create(String lineSeparator)
  {
    nl = lineSeparator;
    EntityManagerJSManageByPropertyForTree result = new EntityManagerJSManageByPropertyForTree();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_37 = "\"," + NL + "\t\tsearchparam:searchparamsCall," + NL + "\t\tautoload: true," + NL + "\t\tshowcheckbox: true," + NL + "\t\tusepager: true," + NL + "\t\tshowseq:true," + NL + "        rowhandler: gridContextmenu," + NL + "\t\trowbinddata: false," + NL + "\t\tonRowDblclick:onRowDblclick," + NL + "\t\tnowrap:false" + NL + "    };" + NL + "    " + NL + "\t//format" + NL + "\t";
