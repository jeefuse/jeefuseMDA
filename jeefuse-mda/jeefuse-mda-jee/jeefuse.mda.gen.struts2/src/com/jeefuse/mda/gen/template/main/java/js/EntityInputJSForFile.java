...
public class EntityInputJSForFile
{
  protected static String nl;
  public static synchronized EntityInputJSForFile create(String lineSeparator)
  {
    nl = lineSeparator;
    EntityInputJSForFile result = new EntityInputJSForFile();
    nl = null;
    return result;
  }
