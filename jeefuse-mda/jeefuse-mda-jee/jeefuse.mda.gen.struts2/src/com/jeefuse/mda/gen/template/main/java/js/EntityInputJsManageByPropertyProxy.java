...
public class EntityInputJsManageByPropertyProxy
{
  protected static String nl;
  public static synchronized EntityInputJsManageByPropertyProxy create(String lineSeparator)
  {
    nl = lineSeparator;
    EntityInputJsManageByPropertyProxy result = new EntityInputJsManageByPropertyProxy();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_72 = NL + "\t/****combo grid*****/";
  protected final String TEXT_73 = NL + "\t//";
  protected final String TEXT_74 = NL + "\t$('#";
  protected final String TEXT_75 = "_";
  protected final String TEXT_76 = "').comboTree({" + NL + "\t\turl: ctx+'";
  protected final String TEXT_77 = "'," + NL + "\t\ticonspath:ctx+\"/resources/style/default/tree/images/\"," + NL + "\t\tkeyEl:'";
  protected final String TEXT_78 = "_";
  protected final String TEXT_79 = "'," + NL + "\t\tonSelect:function(){" + NL + "\t\t\t$(\"#";
  protected final String TEXT_80 = "_";
  protected final String TEXT_81 = "\").valid();" + NL + "\t\t}" + NL + "\t});";
  ...
  protected final String TEXT_133 = NL + "\t\t url:submitUrl," + NL + "\t\t beforeSubmit:function(formData, jqForm, options) {" + NL + "\t\t     \tif(!$(\"#inputForm\").valid()){" + NL + "\t\t\t \t\tvar invalideNum=validator.numberOfInvalids();" + NL + "\t\t\t\t    if(invalideNum>0){" + NL + "\t\t\t\t    \tgoolov.growl.success('有<font color=red> '+invalideNum+'</font> 个选项未填写正确!');" + NL + "\t\t\t\t\t    return false;" + NL + "\t\t\t\t    }" + NL + "\t\t\t\t}" + NL + "\t\t\t\tgoolov.growl.waiting('新增数据中...');" + NL + "\t\t }," + NL + "\t     success:function(result, statusText, xhr, $form) {" + NL + "\t     \t\tgoolov.growl.unwaiting();" + NL + "\t\t\t\tif (result&&result.success) {" + NL + "\t\t\t\t\tgoolov.growl.success(result.message);" + NL + "\t\t\t\t\twindow.parent.addRowData(result.data);" + NL + "\t\t\t\t}else if(result&&result.message){" + NL + "\t\t\t\t\tgoolov.msgbox.error(result.message);" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\tgoolov.msgbox.error();" + NL + "\t\t\t\t}" + NL + "\t\t }," + NL + "\t\t error:function(request,status,errorThrown) {" + NL + "\t\t \tgoolov.growl.unwaiting();" + NL + "\t\t\tgoolov.msgbox.error();" + NL + "\t\t}" + NL + "\t}); " + NL + "}" + NL + "function newWinClose(){" + NL + "\twindow.parent.newWinClose();" + NL + "}" + NL + "function newWinCloseAndRefresh(){" + NL + "\twindow.parent.newWinCloseAndRefresh();" + NL + "}" + NL + "/*******editWinUpdateData******/" + NL + "function editWinUpdateData(){" + NL + "\tvar submitUrl=ctx+'";
  protected final String TEXT_134 = "';";
  protected final String TEXT_135 = NL + "\tvar ";
  protected final String TEXT_136 = "=FCKeditorAPI.GetInstance('fck_";
  protected final String TEXT_137 = "').GetHTML(true);";
  protected final String TEXT_138 = NL + "    $('#inputForm').ajaxSubmit({ " + NL + "\t\t type : 'post'," + NL + "\t\t dataType:'json', ";
  protected final String TEXT_139 = NL + "\t\t data:";
  protected final String TEXT_140 = ",";
  protected final String TEXT_141 = NL + "\t\t url:submitUrl," + NL + "\t\t beforeSubmit:function(formData, jqForm, options) {" + NL + "\t\t     \tif(!$(\"#inputForm\").valid()){" + NL + "\t\t\t \t\tvar invalideNum=validator.numberOfInvalids();" + NL + "\t\t\t\t    if(invalideNum>0){" + NL + "\t\t\t\t    \tgoolov.growl.success('有<font color=red> '+invalideNum+'</font> 个选项未填写正确!');" + NL + "\t\t\t\t\t    return false;" + NL + "\t\t\t\t    }" + NL + "\t\t\t\t}" + NL + "\t\t\t\tgoolov.growl.waiting('新增数据中...');" + NL + "\t\t }," + NL + "\t     success:function(result, statusText, xhr, $form) {" + NL + "\t     \t\tgoolov.growl.unwaiting();" + NL + "\t\t\t\tif (result&&result.success) {" + NL + "\t\t\t\t\tgoolov.growl.success(result.message);" + NL + "\t\t\t\t\twindow.parent.addRowData(result.data);" + NL + "\t\t\t\t}else if(result&&result.message){" + NL + "\t\t\t\t\tgoolov.msgbox.error(result.message);" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\tgoolov.msgbox.error();" + NL + "\t\t\t\t}" + NL + "\t\t }," + NL + "\t\t error:function(request,status,errorThrown) {" + NL + "\t\t \tgoolov.growl.unwaiting();" + NL + "\t\t\tgoolov.msgbox.error();" + NL + "\t\t}" + NL + "\t}); " + NL + "}";
  protected final String TEXT_142 = NL + "/********addNewDataWithEditWin*************/" + NL + "function addNewDataWithEditWin(){" + NL + "\tvar submitUrl=ctx+'";
  protected final String TEXT_143 = "';" + NL + "    $('#inputForm').ajaxSubmit({ " + NL + "\t\t type : 'post'," + NL + "\t\t dataType:'json', " + NL + "\t\t url:submitUrl," + NL + "\t\t beforeSubmit:function(formData, jqForm, options) {" + NL + "\t\t     \tif(!$(\"#inputForm\").valid()){" + NL + "\t\t\t \t\tvar invalideNum=validator.numberOfInvalids();" + NL + "\t\t\t\t    if(invalideNum>0){" + NL + "\t\t\t\t    \tgoolov.growl.success('有<font color=red> '+invalideNum+'</font> 个选项未填写正确!');" + NL + "\t\t\t\t\t    return false;" + NL + "\t\t\t\t    }" + NL + "\t\t\t\t}" + NL + "\t\t\t\tgoolov.growl.waiting('新增数据中...');" + NL + "\t\t }," + NL + "\t     success:function(result, statusText, xhr, $form) {" + NL + "\t     \t\tgoolov.growl.unwaiting();" + NL + "\t\t\t\tif (result&&result.success) {" + NL + "\t\t\t\t\tgoolov.growl.success(result.message);" + NL + "\t\t\t\t\t$(\"#";
  protected final String TEXT_144 = "\").val(result.data.id);" + NL + "\t\t\t\t\twindow.parent.addRowDataWithEditWin(result.data);" + NL + "\t\t\t\t}else if(result&&result.message){" + NL + "\t\t\t\t\tgoolov.msgbox.error(result.message);" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\tgoolov.msgbox.error();" + NL + "\t\t\t\t}" + NL + "\t\t }," + NL + "\t\t error:function(request,status,errorThrown) {" + NL + "\t\t \tgoolov.growl.unwaiting();" + NL + "\t\t\tgoolov.msgbox.error();" + NL + "\t\t}" + NL + "\t}); " + NL + "}";
  protected final String TEXT_145 = NL + "/*******close edit win******/" + NL + "function editWinClose(){" + NL + "\twindow.parent.editWinClose();" + NL + "}" + NL + "function editWinCloseAndRefresh(){" + NL + "\twindow.parent.editWinCloseAndRefresh();" + NL + "}" + NL;
  protected final String TEXT_146 = NL + "var diningDefaultNoPictureUrl=ctx+'/resources/style/default/images/defaultNoPicture.jpg';" + NL + "/*******upload ";
  protected final String TEXT_147 = " image*******/" + NL + "function ";
  protected final String TEXT_148 = "Browse(e){" + NL + "\tif (!goolov.validete.image(e)) {" + NL + "\t\treturn;" + NL + "\t}" + NL + "\t$('#";
  protected final String TEXT_149 = "_image_uploaded').hide();" + NL + "\t$('#";
  protected final String TEXT_150 = "_image_browse').show();" + NL + "\tgoolov.file.previewImage(e,{previewWrapId:'";
  protected final String TEXT_151 = "_image_browse_preview',width:150,height:140});" + NL + "}" + NL + "function ";
  protected final String TEXT_152 = "PreviewRemove(){" + NL + "\tgoolov.file.clear(\"";
  protected final String TEXT_153 = "_image\");" + NL + "\t$('#";
  protected final String TEXT_154 = "_image_browse').hide();" + NL + "\t$('#";
  protected final String TEXT_155 = "_image_uploaded').show();" + NL + "}" + NL + "/*******del photo image********/" + NL + "function ";
  protected final String TEXT_156 = "Del(id){" + NL + "\tvar submitUrl=ctx+'";
  protected final String TEXT_157 = "?id='+id;" + NL + "    $.ajax({ " + NL + "\t\t type : 'post'," + NL + "\t\t dataType:'html', " + NL + "\t\t url:submitUrl," + NL + "\t\t beforeSubmit:function(formData, jqForm, options) {" + NL + "\t\t\t\tgoolov.growl.waiting('正在删除中...');" + NL + "\t\t }," + NL + "\t     success:function(result, statusText, xhr, $form) {" + NL + "\t     \t\tgoolov.growl.unwaiting();" + NL + "\t     \t\tvar result=JSON.parse(result);" + NL + "\t\t\t\tif (result&&result.success) {" + NL + "\t\t\t\t\tgoolov.growl.success(result.message);" + NL + "\t\t\t\t\t";
  protected final String TEXT_158 = "Update();" + NL + "\t\t\t\t}else if(result&&result.message){" + NL + "\t\t\t\t\tgoolov.msgbox.error(result.message);" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\tgoolov.msgbox.error();" + NL + "\t\t\t\t}" + NL + "\t\t }," + NL + "\t\t error:function(request,status,errorThrown) {" + NL + "\t\t \tgoolov.growl.unwaiting();" + NL + "\t\t\tgoolov.msgbox.error();" + NL + "\t\t}" + NL + "\t}); " + NL + "}" + NL + "function ";
  protected final String TEXT_159 = "Update(data){" + NL + "\tgoolov.file.clear('";
  protected final String TEXT_160 = "_image');" + NL + "\t$('#";
  protected final String TEXT_161 = "_image_browse').hide();" + NL + "\tvar oldHtml=[];" + NL + "\tif(data&&data.";
  protected final String TEXT_162 = "){" + NL + "\t\toldHtml.push('<img ',' width=\"',150,'\" height=\"'+140+'\" src=\"'+ctx+'/'+data.";
  protected final String TEXT_163 = "+'\"/>');" + NL + "\t\t//oldHtml.push('<span class=\"label\">已上传</span><a href=\"javascript:";
  protected final String TEXT_164 = "Del(\\''+data.id+'\\');\" class=\"remove\" >删除</a>');" + NL + "\t\toldHtml.push('<span class=\"label\">已上传</span>');" + NL + "\t}else{" + NL + "\t\toldHtml.push('<img ',' width=\"',150,'\" height=\"'+140+'\" src=\"'+diningDefaultNoPictureUrl+'\"/>');" + NL + "\t}" + NL + "\t$('#";
  protected final String TEXT_165 = "_image_uploaded').empty().html(oldHtml.join('')).show();//.fadeOut(250, function() { $(this).remove();});" + NL + "}";
  protected final String TEXT_166 = NL + "/*******del ";
  protected final String TEXT_167 = " file********/" + NL + "function ";
  protected final String TEXT_168 = "Del(id){" + NL + "\tvar submitUrl=ctx+'";
  protected final String TEXT_169 = "?id='+id;" + NL + "    $.ajax({ " + NL + "\t\t type : 'post'," + NL + "\t\t dataType:'html', " + NL + "\t\t url:submitUrl," + NL + "\t\t beforeSubmit:function(formData, jqForm, options) {" + NL + "\t\t\t\tgoolov.growl.waiting('正在删除中...');" + NL + "\t\t }," + NL + "\t     success:function(result, statusText, xhr, $form) {" + NL + "\t     \t\tgoolov.growl.unwaiting();" + NL + "\t     \t\tvar result=JSON.parse(result);" + NL + "\t\t\t\tif (result&&result.success) {" + NL + "\t\t\t\t\tgoolov.growl.success(result.message);" + NL + "\t\t\t\t\t";
  protected final String TEXT_170 = "Update();" + NL + "\t\t\t\t}else if(result&&result.message){" + NL + "\t\t\t\t\tgoolov.msgbox.error(result.message);" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\tgoolov.msgbox.error();" + NL + "\t\t\t\t}" + NL + "\t\t }," + NL + "\t\t error:function(request,status,errorThrown) {" + NL + "\t\t \tgoolov.growl.unwaiting();" + NL + "\t\t\tgoolov.msgbox.error();" + NL + "\t\t}" + NL + "\t}); " + NL + "}";
  protected final String TEXT_171 = NL + "/*******rel ";
  protected final String TEXT_172 = " manager**********/" + NL + "var ";
  protected final String TEXT_173 = "Win;" + NL + "function ";
  protected final String TEXT_174 = "WinInit(){" + NL + "\tif(!";
  protected final String TEXT_175 = "Win){" + NL + "\t\t";
  protected final String TEXT_176 = "Win=new goolov.winbox({" + NL + "\t\t\twidth:goolov.winWidth(750)," + NL + "\t\t\theight:goolov.winHeight(450)," + NL + "\t\t\tmodal:true," + NL + "\t\t\tneeedReLoad:false" + NL + "\t\t});" + NL + "\t}" + NL + "}" + NL + "function ";
  protected final String TEXT_177 = "WinOpen(settings){" + NL + "\t";
  protected final String TEXT_178 = "WinInit();" + NL + "\t";
  protected final String TEXT_179 = "Win.open(settings);" + NL + "}" + NL + "function ";
  protected final String TEXT_180 = "WinClose(){" + NL + "\t";
  protected final String TEXT_181 = "Win.close();" + NL + "}" + NL + "function ";
  protected final String TEXT_182 = "(id,name){" + NL + "\tvar title='";
  protected final String TEXT_183 = "选择';" + NL + "\tvar url=ctx+'";
  protected final String TEXT_184 = "';" + NL + "\t";
  protected final String TEXT_185 = "WinOpen({title:title,url:url});" + NL + "}" + NL + "function ";
  protected final String TEXT_186 = "Process(id,name){" + NL + "\t$('#";
  protected final String TEXT_187 = "_";
  protected final String TEXT_188 = "').val(id);" + NL + "\t$('#";
  protected final String TEXT_189 = "_";
  protected final String TEXT_190 = "').val(name);" + NL + "\t";
  protected final String TEXT_191 = "WinClose();" + NL + "\tvalidator.form();" + NL + "}" + NL + "function relGlDiningSiteListForSelectClear(){" + NL + "\t$('#";
  protected final String TEXT_192 = "_";
  protected final String TEXT_193 = "').val('');" + NL + "\t$('#";
  protected final String TEXT_194 = "_";
  protected final String TEXT_195 = "').val('');" + NL + "}";
