...
public class EntityInputForImageJSP
{
  protected static String nl;
  public static synchronized EntityInputForImageJSP create(String lineSeparator)
  {
    nl = lineSeparator;
    EntityInputForImageJSP result = new EntityInputForImageJSP();
    nl = null;
    return result;
  }
